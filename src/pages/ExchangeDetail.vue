<template>
  <!-- 디폴트 이미지가 보이지 않도록 v-if처리해서 데이터가 있을 경우 렌더링 -->
        ...
        <div class="container">
          <div class="columns">
            <div class="column is-9">
              ...
              <!-- Exchange User Start -->
              <!-- 유저정보가 있을 경우에만 표시 오브젝트이므로 !!로 Boolean으로 변환 -->
              <div v-if="!!exchangeUser" class="user-tile">
                ...
                <div class="user-tile-author center">
                  <h3 class="user-tile-author-name">
                    by {{ exchangeUser.username }} | IS-OWNER :
                    {{ isExchangeOwner ? "OWNER" : "NOT OWNER" }}
                  </h3>
                </div>
              </div>
              <!-- Exchange User End -->
                ...
                <div class="card">
                  ...
                  <div class="card-content">
                    ...
                    <button
                      ...
                      disabled
                      class="button is-danger is-fullwidth is-large is-outlined"
                    >
                      Your exchange
                    </button>
                    <router-link
                      v-if="!isAuth"
                      class="button is-success is-fullwidth is-large is-outlined"
                      to="/login"
                    >
...
export default {
  ...
  computed: {
    ...
    userExchanges() {
      return this.user.exchanges || []; // 이게 없으면 에러 발생가능
    },
    exchange() {
